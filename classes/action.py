...
class addAction(wx.Dialog):
	...
	def __init__(self,actions_options,time_units):
		...
		wx.Dialog.__init__(self, None, title=_('Add action'), size=(330,320))
		...
		self.times = wx.TextCtrl(panel, size=(150, 32), pos=(10, 215))
		self.times.SetValue('0')
		wx.StaticText(panel, label=_('leave 0 if you want the action to be repeated\nindefinitely until the trigger becomes false'), pos=(170, 220))
