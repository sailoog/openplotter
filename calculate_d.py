...
while True:
	...
	if now-sent >= rate:
		...
		if  conf.get('CALCULATE', 'nmea_mag_var')=='1' and mag_var[0]:
		...
		if conf.get('CALCULATE', 'tw_stw')=='1' and STW and AWS and AWA:
			#TWA
		...
		if conf.get('CALCULATE', 'tw_sog')=='1' and SOG and COG and heading_t and AWS and AWA:
			#TWD
			D=heading_t-COG
